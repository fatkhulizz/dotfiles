...
alias e='eza'
alias nv='nvim'
alias nvvsc='NVIM_APPNAME=nvvsc nvim'
alias nvlazy='NVIM_APPNAME=nvlazy nvim'
...
# platformIO
# export PLATFORMIO="$HOME/.platformio/penv"
# export PATH="$PLATFORMIO/bin:$PATH"
